  ...
  public: {
    Tables: {
      ...
      help_intent_phrases: {
        ...
        Relationships: [
          {
            foreignKeyName: "help_intent_phrases_intent_id_fkey"
            columns: ["intent_id"]
            isOneToOne: false
            referencedRelation: "help_intents"
            referencedColumns: ["id"]
          },
        ]
      }
      help_intents: {
        ...
        Relationships: [
          {
            foreignKeyName: "help_intents_article_id_fkey"
            columns: ["article_id"]
            isOneToOne: false
      ...
      help_unanswered: {
        ...
        Relationships: [
          {
            foreignKeyName: "help_unanswered_article_id_fkey"
            columns: ["article_id"]
            isOneToOne: false
            referencedRelation: "help_articles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "help_unanswered_ticket_id_fkey"
            columns: ["ticket_id"]
            isOneToOne: false
            referencedRelation: "tickets"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      complete_initial_review: {
        Args: {
          _confirmed_service_ids: string[]
          _inspected_ids: string[]
          _mode?: string
          _motorcycle_id: string
          _unconfirmed_ids: string[]
        }
        Returns: Json
      }
      complete_signup_cpf: {
      ...
      link_ticket_to_unanswered: {
        Args: { _ticket_id: string; _unanswered_id: string }
        Returns: boolean
      }
      ...
      record_help_unanswered: {
        Args: { _module_key?: string; _query_text: string; _route?: string }
        Returns: string
      }
      ...
      resolve_help_unanswered: {
        Args: { _article_id?: string; _id: string }
        Returns: boolean
      }
      ...
      update_maintenance_and_recompose: {
        Args: {
          _cost_adjustment?: number
          _description?: string
          _event_id: string
          _hours_delta?: number
          _items_delete?: string[]
          _items_upsert?: Json
          _km_delta?: number
          _location?: string
          _moto_id: string
    ...
    Enums: {
      ...
      inspection_decision:
        ...
        | "postpone"
        | "ignore"
      item_kind: "technical" | "labor" | "expense"
