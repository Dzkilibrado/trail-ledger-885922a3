            ...
            <div className="text-center py-6">
              ...
              <div className="mt-6 flex flex-wrap justify-center gap-2">
                ...
                {isAuthed ? (
                  ...
                  <Button className="btn-glow" onClick={() => navigate({ to: "/auth", search: { tab: "signin" as const, recuperar: undefined } })}>
                    Voltar ao login
                  </Button>
                )}
              </div>
                ...
                <div className="flex flex-col sm:flex-row gap-2 pt-2">
                  {isAuthed ? (
                    ...
                    <Button
                      ...
                      variant="outline"
                      className="sm:w-40"
                      onClick={() => navigate({ to: "/auth", search: { tab: "signin" as const, recuperar: undefined } })}
                    >
                      Voltar ao login
                    </Button>
                  )}
