  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={<OpenTicketButton label="Novo chamado" className="btn-glow" />}
      />
      ...
      {isLoading ? (
        ...
        <div className="rounded-xl border border-dashed border-border p-10 text-center">
          ...
          <OpenTicketButton label="Abrir chamado" className="mt-4" />
        </div>
      ) : (
...
function OpenTicketButton({ label, className }: { label: string; className?: string }) {
  return (
