    ...
    <div className="mx-auto max-w-3xl space-y-6">
        ...
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-1 flex flex-wrap items-center gap-1">
              <span
                className={`rounded-full px-2 py-0.5 text-[10px] font-bold uppercase tracking-widest ${isAdmin ? "bg-emerald-500/15 text-emerald-400" : "bg-foreground/10 text-foreground/70"}`}
              >
                {isAdmin ? (
                  <>
                    <Shield className="mr-1 inline h-3 w-3" /> Administrador
                  </>
                ) : (
                  "Usuário"
                )}
      ...
      {p?.cpf && (
        <p className="text-xs text-muted-foreground">
          ...
          <Link to="/tickets/cpf-change" className="text-primary hover:underline">
